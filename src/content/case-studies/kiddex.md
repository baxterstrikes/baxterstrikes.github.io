...
Suddenly a dozen adults needed to know exactly the right things about one small person — the sitter, the grandparents, the school office, the camp nurse, the coach doing pickup. I became the switchboard: the same facts retyped into every form, texted to every new caregiver, stale the moment I hit send.
