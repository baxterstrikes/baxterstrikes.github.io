...
My first answer was to give the vault a voice: a couple thousand hand-rolled lines running one household bot, vault-aware, with a permission system I was proud of. Then I found an open-source agent framework — four months old, already the fastest-growing of its kind — that did all of it better, and was maintained by people who weren't me.
...
And the part "done" doesn't fix: it's still mine. Thinner, better documented — and a bespoke machine cut to the shape of one life. I keep choosing that trade on purpose.
